...
abstract class AbstractIdeLightClassTest : KotlinLightCodeInsightFixtureTestCase() {
    fun doTest(testDataPath: String) {
        ...
        testLightClass(project, testDataPath)
    }

    override fun getProjectDescriptor() = KotlinWithJdkAndRuntimeLightProjectDescriptor.INSTANCE
}

public abstract class AbstractIdeCompiledLightClassTest : KotlinLightCodeInsightFixtureTestCase() {
    override fun setUp() {
        super.setUp()
    ...
    override fun tearDown() {
        ConfigLibraryUtil.removeLibrary(myFixture.module, libName())
...
private fun testLightClass(project: Project, testDataPath: String) {
