...
enum class MoveAction {
    ...
    MOVE_KOTLIN_NESTED_CLASS {
        override fun runRefactoring(rootDir: VirtualFile, mainFile: PsiFile, elementAtCaret: PsiElement?, config: JsonObject) {
            ...
            val moveKind = MoveDeclarationsDelegate.NestedClass(config.getNullableString("newName"),
            ...
            val moveTarget =
                    if (targetClass != null) {
                        ...
                        val fileName = (moveKind.newClassName ?: elementToMove.name!!) + ".kt"
            ...
            val descriptor = MoveDeclarationsDescriptor(listOf(elementToMove), moveTarget, moveKind)
