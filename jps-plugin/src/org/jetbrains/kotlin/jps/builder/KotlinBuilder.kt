...
package org.jetbrains.kotlin.jps.builder
...
import org.jetbrains.kotlin.builder.GeneratedFile
import org.jetbrains.kotlin.builder.GeneratedJvmClass
import org.jetbrains.kotlin.builder.isModuleMappingFile
...
class KotlinBuilder : ModuleLevelBuilder(BuilderCategory.SOURCE_PROCESSOR) {
    companion object {
        ...
        val LOG = Logger.getInstance("#" + KotlinBuilder::class.java.name)
    }
