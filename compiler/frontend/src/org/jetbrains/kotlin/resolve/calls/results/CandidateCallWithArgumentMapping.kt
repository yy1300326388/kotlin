...
class CandidateCallWithArgumentMapping<D : CallableDescriptor, K> private constructor(
        ...
        val unusedParametersCount: Int
) {
    override fun toString(): String =
            "${resolvedCall.call}: $unusedParametersCount unused in ${resolvedCall.candidateDescriptor}"
    ...
    companion object {
        fun <D : CallableDescriptor, K> create(
            ...
            return CandidateCallWithArgumentMapping(call, argumentsToParameters, unusedParametersCount)
        }
    }
}
