...
trait ConvertedCodeProcessor {
    fun convertVariableUsage(expression: PsiReferenceExpression, converter: Converter): Expression? = null

    fun convertMethodUsage(methodCall: PsiMethodCallExpression, converter: Converter): Expression? = null
}
