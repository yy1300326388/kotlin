...
<!RETURN_TYPE_MISMATCH_ON_INHERITANCE!>interface Test4<!><T : IBase> : JFooWithUpperBound<T>, IFoo

<!RETURN_TYPE_MISMATCH_ON_INHERITANCE!>interface Test5<!><T : IDerived> : JFooWithUpperBoundDerived<T>, IFooDerived
