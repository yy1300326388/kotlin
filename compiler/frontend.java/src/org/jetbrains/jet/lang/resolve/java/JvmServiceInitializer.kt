...
public class JvmLazyAnalyzerPostConstruct : AnalyzerPostConstruct() {
    ...
    [PostConstruct] override fun postCreate() {
        AnalyzeSessionProvider.getInstance(project!!).initialize(trace!!, codeAnalyzer!!.getModuleDescriptor(), codeAnalyzer)
    }
}

public class JvmDescriptorResolverPostCreate: AnalyzerPostConstruct() {
    public var project: Project? = null
        [Inject] set
    ...
    [PostConstruct] override fun postCreate() {
        AnalyzeSessionProvider.getInstance(project!!).initialize(trace!!, module!!, null)
    }
}
