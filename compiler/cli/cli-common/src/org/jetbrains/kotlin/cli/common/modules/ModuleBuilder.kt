...
public class ModuleBuilder(
    ...
    private val javaSourceRoots = ArrayList<JavaSourceRoot>()
    ...
    public fun addJavaSourceRoot(root: JavaSourceRoot) {
        javaSourceRoots.add(root)
    }

    override fun getOutputDirectory(): String = outputDir
    override fun getJavaSourceRoots(): List<JavaSourceRoot> = javaSourceRoots
