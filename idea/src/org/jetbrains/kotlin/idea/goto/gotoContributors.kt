...
/*
* There is separate logic in IDEA that adds classes to "go to symbol" popup result that goes around GotoClassContributor.
* For Kotlin classes in works using light class generation.
